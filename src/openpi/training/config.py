...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        project_name="pi05_tea_use_spoon",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
    ...
    TrainConfig(
        name="pi05_tea_pour_ice",
        project_name="pi05_tea_pour_ice",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotOpenArmDataConfig(
            repo_id="qrafty-ai/tea_pour_ice",
            assets=AssetsConfig(asset_id="qrafty-ai/tea_pour_ice"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=16,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        name="pi05_tea_use_steel_spoon",
        project_name="pi05_tea_use_steel_spoon",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotOpenArmDataConfig(
            repo_id="qrafty-ai/tea_use_steel_spoon",
            assets=AssetsConfig(asset_id="qrafty-ai/tea_use_steel_spoon"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=16,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        name="pi05_tea_pick_cup",
        project_name="pi05_tea_pick_cup",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=LeRobotOpenArmDataConfig(
            repo_id="qrafty-ai/tea_pick_cup",
            assets=AssetsConfig(asset_id="qrafty-ai/tea_pick_cup"),
            base_config=DataConfig(prompt_from_task=False),
            dataset_action_dim=16,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
