    ...
    def forward(
        ...
        for encoder_layer in self.layers:
            if output_hidden_states:
                encoder_states = encoder_states + (hidden_states,)  # noqa: RUF005
            ...
            if output_attentions:
                all_attentions = all_attentions + (layer_outputs[1],)  # noqa: RUF005
...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor, interpolate_pos_encoding=False) -> torch.Tensor:  # noqa: FBT002
...
class SiglipVisionTransformer(nn.Module):
    ...
    def forward(
        ...
        output_attentions: bool | None = None,
        output_hidden_states: bool | None = None,
        interpolate_pos_encoding: bool | None = False,  # noqa: FBT002
    ):
        output_attentions = output_attentions if output_attentions is not None else self.config.output_attentions
        output_hidden_states = (
            output_hidden_states if output_hidden_states is not None else self.config.output_hidden_states
...
class SiglipVisionModel(nn.Module):
    ...
    def forward(
        ...
        output_attentions: bool | None = None,
        output_hidden_states: bool | None = None,
        interpolate_pos_encoding: bool = False,  # noqa: FBT001, FBT002
    ):
