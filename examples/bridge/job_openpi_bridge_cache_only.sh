...
# Cache-Only Training Job Script
# This version uses ONLY metadata (92MB) + HuggingFace cache (152GB)
# No need to upload the original Parquet dataset (saves 152GB!)
...
# IMPORTANT: Cache-Only Dataset Configuration
# This is the key environment variable that enables cache-only loading
...
export HF_LEROBOT_HOME=${DATASET_ROOT}/datasets/openx
...
# ======================
echo "=========================================="
echo "Cache-Only Training Configuration"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "Required Files on Cluster:"
echo "=========================================="
echo "1. Metadata directory (92MB):"
echo "   ${HF_LEROBOT_HOME}/bridge_lerobot_224/meta/"
echo "   - info.json"
echo "   - episodes.jsonl"
echo "   - tasks.jsonl"
echo "   - episodes_stats.jsonl"
echo ""
echo "2. HuggingFace cache (152GB):"
echo "   ${HF_DATASETS_CACHE}/"
echo "   - Upload from local: /data/jerry/datasets/openx/cache/datasets/"
echo "   - All *.arrow files and dataset_info.json"
echo ""
echo "3. PyTorch weights:"
echo "   ${PYTORCH_WEIGHT_PATH}/"
echo "   - model.safetensors"
echo "   - config.json"
echo ""
echo "4. Big Vision tokenizer:"
echo "   ${OPENPI_DATA_HOME}/big_vision/"
echo "   - paligemma_tokenizer.model"
echo ""
echo "5. Normalization stats:"
echo "   assets/pi0_bridge_finetune/bridge_lerobot_224/"
echo "   - norm_stats.json"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "Starting Cache-Only Training"
echo "=========================================="
...
echo "  LeRobot Home (metadata only): $HF_LEROBOT_HOME"
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    echo "=========================================="
    echo "Cache-Only Training completed successfully!"
    echo "Check outputs at: $CHECKPOINT_DIR/pi0_bridge_finetune/$EXP_NAME/"
    echo "=========================================="
    echo ""
    echo "Storage Saved:"
    echo "  Original dataset would have been: 304GB"
    echo "  Cache-only approach uses: 152GB"
    echo "  Savings: 152GB (50%)"
else
    echo "=========================================="
